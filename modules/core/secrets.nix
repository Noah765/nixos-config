{lib, ...}: {
  nixos = {
    ...
    config = lib.mkIf config.core.secrets.enable {
      ...
      security.pam.u2f.settings.authfile = pkgs.writeText "u2f-mappings" "noah:7s47t+qdwDRrR2Q2xTPY4cj4i83SVaTu6QZStuVO0bj0mW67Uj8yrW8rdRiQuhe3mF8n/tP0YERLT8fBnxdh0Q==,GtG20Gc4x16lpa7SSWFA5sIJw8A/WWWpq2FuuLAjOinuVD75X+qXaB0K8EyKTFdlqIPlROc6GHCckArbenSJWw==,es256,+presence";
    };
  };
}
