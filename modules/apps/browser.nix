{
  ...
  flake.wrappers.browser = {
    ...
    config = {
      ...
      flags."--config-py" = config.constructFiles.generatedConfig.path;

      constructFiles.generatedConfig.content = let
      ...
      '';
      constructFiles.generatedConfig.relPath = "${config.binName}-config.py";
    };
  };
